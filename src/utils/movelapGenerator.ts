  ...
  for (let seqIndex = 0; seqIndex < sequences.length; seqIndex++) {
    ...
    for (let i = 1; i <= sequence.repetitions; i++) {
      ...
      const movelap: MovelapData = {
        ...
        pace: globalFields.pace100 || null,
        time: globalFields.time || null,
        reps: sequence.reps || null,
        restType: null,
        pause: pause || null,
        alarm: globalFields.alarm || null,
        sound: globalFields.sound || null,
        notes: globalFields.note || null,
        status: 'PENDING',
        isSkipped: false,
        isDisabled: false
      };
